...
First, install this package, ESLint and the necessary plugins.
  ...
  ```sh
  npm install --save-dev eslint-config-react-app babel-eslint@^8.2.2 eslint@^4.1.1 eslint-plugin-flowtype@^2.34.1 eslint-plugin-import@^2.6.0 eslint-plugin-jsx-a11y@^6.0.2 eslint-plugin-react@^7.8.2
  ```
