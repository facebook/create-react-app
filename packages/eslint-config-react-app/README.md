...
First, install this package, ESLint and the necessary plugins.
  ...
  ```sh
  npm install --save-dev @webstronauts/eslint-config-react-app babel-eslint@7.1.1 eslint@3.16.1 eslint-plugin-flowtype@2.21.0 eslint-plugin-import@2.0.1 eslint-plugin-jsx-a11y@4.0.0 eslint-plugin-react@6.4.1
  ```
