...
This package includes the shareable ESLint configuration used by [Create React App](https://github.com/webstronauts/create-react-app).<br>
...
The easiest way to use this configuration is with [Create React App](https://github.com/webstronauts/create-react-app), which includes it by default.
...
However, if you are using [Create React App](https://github.com/webstronauts/create-react-app) and have not ejected, any additional rules will only be displayed in the [IDE integrations](https://github.com/webstronauts/create-react-app/blob/master/packages/react-scripts/template/README.md#displaying-lint-output-in-the-editor), but not in the browser or the terminal.
