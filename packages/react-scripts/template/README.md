...
* Inside virtual machines such as (a Vagrant provisioned) VirtualBox, use `npm i --save-dev cross-env` and then [`cross-env CHOKIDAR_USEPOLLING=true npm start`](https://github.com/facebookincubator/create-react-app/issues/1049#issuecomment-261731734).
