...
BUILD_DIR | :x: | :white_check_mark: | Some tools like cordova require your built files to exist in a particular directory, such as 'www'. This lets you change the default output folder.
