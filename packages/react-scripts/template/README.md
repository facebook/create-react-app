...
CHOKIDAR_USEPOLLING | :white_check_mark: | :x: | Switches the watcher into polling mode, as necessary inside a VM. Use this option if `npm start` isn't detecting changes.
