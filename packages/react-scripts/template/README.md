...
* Alternatively, you can use [a trick](https://help.github.com/articles/creating-a-custom-404-page-for-your-github-pages-site/) to make GitHub Pages redirect 404s to your `index.html` page with a special redirect parameter. When using `react-scripts@0.5.0` or higher, you can place your `404.html` file inside the `public` folder. You’ll need to include code in `index.html` to handle the redirect parameter. You can find a detailed explanation of this technique [in this guide](https://github.com/rafrex/spa-github-pages). For earlier versions of `react-scripts`, manually add your `404.html` file to the `build` folder before deploying.
