...
BUILD_DIR | :x: | :white_check_mark: | By default, production builds are written to `./build`. By setting this variable, you can override the output directory. (e.g. `BUILD_DIR=./dist`)
