This project was bootstrapped with [BA Create React App](https://github.com/bluealba/ba-create-react-app).
...
This will format all of your files using your prettier rules.
