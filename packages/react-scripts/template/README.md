...
NODE_PATH | :white_check_mark: | :white_check_mark: | When set to `src`, This lets you use absolute paths in imports inside large monorepos: See [issues/253](https://github.com/facebookincubator/create-react-app/issues/253).
