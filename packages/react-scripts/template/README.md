...
If this has not helped, there are a few other things you can try:
  ...
  6. Check if <file path> is outside your project directory.
     For example, you might have accidentally installed something in your home folder.

  7. Try running npm ls OFFENDING PACKAGE in your project folder.
     This will tell you which other package (apart from the expected react-scripts) installed OFFENDING PACKAGE.
