...
| INLINE_RUNTIME_CHUNK |          :x:           | :white_check_mark: | By default in production, Create React App will embed the runtime script into the `index.html`. By setting this environment variable to `false`, the script will not be embedded and will be imported as usual. This is handy for dealing with CSP                                                                                                                                                                                                                                                                                                                                                                                                                       |
