...
module.exports = function (webpackEnv) {
  ...
  return {
    ...
    output: {
      ...
      jsonpFunction: `MAGIC_${appPackageJson.name}`,
    ...
    resolve: {
      ...
      modules: ['node_modules', paths.appSrc, paths.ownNodeModules, paths.appNodeModules].concat(
      ...
      useTypeScript &&
        new ForkTsCheckerWebpackPlugin({
          ...
          reportFiles: [
            ...
            // '../cra-template-typescript/template/resources/App.tsx'
            // otherwise.
            '../**/resources/**/*.{ts,tsx}',
            '**/resources/**/*.{ts,tsx}',
            '!**/resources/**/__tests__/**',
            '!**/resources/**/?(*.)(spec|test).*',
            '!**/resources/setupProxy.*',
            '!**/resources/setupTests.*',
          ],
          silent: true,
