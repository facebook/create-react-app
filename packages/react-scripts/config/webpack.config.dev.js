...
const publicPath = '/';
// const publicPath = 'v${buildManifest.getAppVersion()}/files';
// const publicPath = '/v0.1.3/files/';
...
module.exports = {
  ...
  entry: {
    dev: [
      ...
      require.resolve(paths.deskproHelpdeskStub),
      require.resolve('../deskpro/helpdeskStub'),
    ],
