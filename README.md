# Create React App [![Build Status](https://travis-ci.org/facebook/create-react-app.svg?branch=master)](https://travis-ci.org/facebook/create-react-app) [![install size](https://packagephobia.now.sh/badge?p=create-react-app)](https://packagephobia.now.sh/result?p=create-react-app)
