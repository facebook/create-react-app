...
More detailed information is in the dedicated [README](/test/README.md).
...
We use [verdaccio](https://github.com/verdaccio/verdaccio) to emulate packages publishing in a registry using a default configuration. You can modify the current behaviour by editing the file `task/verdaccio.yaml`.
