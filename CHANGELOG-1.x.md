...
- `react-scripts`
  ...
  - [#3730](https://github.com/facebook/create-js-app/pull/3730) Print when `HOST` environment variable is set. ([@iansu](https://github.com/iansu))
...
- User Guide
  ...
  - [#3510](https://github.com/facebook/create-js-app/pull/3510) Update User Guide with deploying to GitHub User pages. ([@aaronlna](https://github.com/aaronlna))
...
- `react-dev-utils`
  ...
  - [#3368](https://github.com/facebook/create-js-app/pull/3368) Fix a crash in development mode in older browsers. ([@felthy](https://github.com/felthy))
...
- `react-dev-utils`
  ...
  - [#2282](https://github.com/facebook/create-js-app/pull/2282) Add Windows Subsystem for Linux support to the error overlay. ([@noinkling](https://github.com/noinkling))
...
**For a readable summary of the changes, [check out our blog post](https://facebook.github.io/react/blog/2017/05/18/whats-new-in-create-js-app.html).**
...
- `react-dev-utils`
  ...
  - [#2120](https://github.com/facebook/create-js-app/pull/2120) Omit ESLint warnings when there are ESLint errors. ([@gaearon](https://github.com/gaearon))
...
- `react-scripts`
  ...
  - [#1657](https://github.com/facebook/create-js-app/pull/1657) Set Chrome userDataDir to be under .vscode folder. ([@ryansully](https://github.com/ryansully))
- Other
  - [#2135](https://github.com/facebook/create-js-app/pull/2135) Add note about `yarn.lock`. ([@viankakrisna](https://github.com/viankakrisna))
  - [#2040](https://github.com/facebook/create-js-app/pull/2040) Fix typo. ([@tijwelch](https://github.com/tijwelch))
  - [#1991](https://github.com/facebook/create-js-app/pull/1991) Add folder structure docs for new contributors. ([@anilreddykatta](https://github.com/anilreddykatta))
  - [#1962](https://github.com/facebook/create-js-app/pull/1962) Add sku to the list of alternatives. ([@markdalgleish](https://github.com/markdalgleish))
  - [#1799](https://github.com/facebook/create-js-app/pull/1799) Improve phrasing. ([@moniuch](https://github.com/moniuch))
- `babel-preset-react-app`
  - [#1787](https://github.com/facebook/create-js-app/pull/1787) Update side-effect documentation. ([@evenchange4](https://github.com/evenchange4))

#### :house: Internal

- `react-scripts`
  - [#2213](https://github.com/facebook/create-js-app/pull/2213) Use some ES6 syntax. ([@shashkovdanil](https://github.com/shashkovdanil))
  - [#1913](https://github.com/facebook/create-js-app/pull/1913) Add linked modules test. ([@Timer](https://github.com/Timer))
  ...
  - [#1715](https://github.com/facebook/create-js-app/pull/1715) Remove unused `url` import in Webpack config. ([@pd4d10](https://github.com/pd4d10))
  - [#1700](https://github.com/facebook/create-js-app/pull/1700) Update extract-text-webpack-plugin to stable. ([@SimenB](https://github.com/SimenB))
- `react-dev-utils`, `react-scripts`
  - [#2209](https://github.com/facebook/create-js-app/pull/2209) Move more logic from react-scripts to react-dev-utils. ([@gaearon](https://github.com/gaearon))
  - [#2138](https://github.com/facebook/create-js-app/pull/2138) Add custom eslint formatter. ([@doshisid](https://github.com/doshisid))
- `babel-preset-react-app`, `react-scripts`
  - [#2175](https://github.com/facebook/create-js-app/pull/2175) Resolve regenerator runtime relative to react-scripts. ([@gaearon](https://github.com/gaearon))
  - [#1894](https://github.com/facebook/create-js-app/pull/1894) Re-disable babel modules transform. ([@Timer](https://github.com/Timer))
  - [#1742](https://github.com/facebook/create-js-app/pull/1742) Switch to preset-env. ([@Timer](https://github.com/Timer))
- `create-js-app`, `react-dev-utils`, `react-scripts`
  - [#1897](https://github.com/facebook/create-js-app/pull/1897) Bump minimal Node version to 6. ([@ianschmitz](https://github.com/ianschmitz))
- Other
  - [#1868](https://github.com/facebook/create-js-app/pull/1868) Fix AppVeyor CI. ([@darrenscerri](https://github.com/darrenscerri))
  - [#1825](https://github.com/facebook/create-js-app/pull/1825) Added test to check for accidental extraneous dependencies. ([@lpalmes](https://github.com/lpalmes))
  - [#1876](https://github.com/facebook/create-js-app/pull/1876) Fix AppVeyor CI. ([@darrenscerri](https://github.com/darrenscerri))
  ...
  - [#1688](https://github.com/facebook/create-js-app/pull/1688) Pin and upgrade lerna version. ([@viankakrisna](https://github.com/viankakrisna))
  - [#1648](https://github.com/facebook/create-js-app/pull/1648) Add `appveyor.yml`. ([@Timer](https://github.com/Timer))
- `babel-preset-react-app`, `create-js-app`, `eslint-config-react-app`, `react-dev-utils`, `react-scripts`
  - [#1738](https://github.com/facebook/create-js-app/pull/1738) Update to modern code style (ES6). ([@tuchk4](https://github.com/tuchk4))
- `eslint-config-react-app`
