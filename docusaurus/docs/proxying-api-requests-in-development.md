...
> **Note:** This file does not support ES Modules. But, if you would like more than what Node's JavaScript syntax has to offer (e.g. TypeScript support), install `@babel/register` as a dependency or devDependency using npm or Yarn
