...
Runs the app in the local development mode. Since Create React App is made for local ReactJS development, you need to open [http://localhost:3000](http://localhost:3000) to view it in the browser.
