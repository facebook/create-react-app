...
> [Read the migration guide to learn how to enable it in older projects!](https://github.com/facebook/create-js-app/blob/master/CHANGELOG-0.x.md#migrating-from-023-to-030)
