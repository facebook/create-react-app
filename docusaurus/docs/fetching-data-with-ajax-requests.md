...
For example, support in Internet Explorer requires a [polyfill](https://github.com/facebook/create-js-app/blob/master/packages/react-app-polyfill/README.md).
