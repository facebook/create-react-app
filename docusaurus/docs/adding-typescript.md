...
>
> Global installs of `create-js-app` are no longer supported.
...
If your project is not created with TypeScript enabled, npx may be using a cached version of `create-js-app`. Remove previously installed versions with `npm uninstall -g create-js-app` (see [#6119](https://github.com/facebook/create-js-app/issues/6119#issuecomment-451614035)).

If you are currently using [create-js-app-typescript](https://github.com/wmonk/create-js-app-typescript/), see [this blog post](https://vincenttunru.com/migrate-create-js-app-typescript-to-create-js-app/) for instructions on how to migrate to Create React App.
