...
In addition, the [craco](https://github.com/dilanx/craco) and the [react-app-rewired](https://github.com/timarney/react-app-rewired) package are useful for editing react configuration files without ejecting.
